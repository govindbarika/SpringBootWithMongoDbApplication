package com.govindonjava.springbootwithmongodb.controller;
...
import com.govindonjava.springbootwithmongodb.repository.BookingRepository;
...
public class BookingController {
 ...
 public Map<String, Object> create(Booking booking) {
  booking.setTravelDate((Date) new Date());
 ...
 public Map<String, Object> read(@RequestParam String bookingId) {
  Optional bookingOptl = bookingRepository.findById(bookingId);
  Booking booking = null;
  
  if(bookingOptl.isPresent()) {
	  booking = (Booking) bookingOptl.get();
  }
  Map<String, Object> dataMap = new HashMap<String, Object>();
